...
//       <h1 className="text-4xl font-bold mb-6 text-blue-700">Абитуриенту</h1>

//       <p className="text-lg mb-4">
//         Добро пожаловать в Высший колледж IT и новых технологий! Здесь вы найдете всю необходимую информацию для поступления и начала обучения в нашем колледже.
//       </p>

//       <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600">Условия поступления</h2>
//       <ul className="list-disc list-inside space-y-2 text-lg">
//         <li>Заявление на поступление принимается онлайн и офлайн.</li>
//         <li>Необходимые документы: удостоверение личности, аттестат/свидетельство об образовании, фотографии.</li>
//         <li>Поступление осуществляется по результатам вступительных испытаний или конкурса аттестатов.</li>
//         <li>Предусмотрены льготы для отдельных категорий абитуриентов (дети-сироты, многодетные семьи и др.).</li>
//       </ul>

//       <h2 className="text-2xl font-semibold mt-8 mb-4 text-blue-600">Программы подготовки</h2>
//       <ul className="list-disc list-inside space-y-2 text-lg">
//         <li>Программное обеспечение и разработка</li>
//         <li>Кибербезопасность</li>
//         <li>Сетевое и системное администрирование</li>
//         <li>Мобильная разработка</li>
//         <li>Веб-разработка</li>
//         <li>Цифровые технологии и автоматизация</li>
//       </ul>

//       <p className="text-lg mt-8">
//         Мы готовы помочь вам сделать первые шаги в мир современных технологий. Присоединяйтесь к нам и станьте частью будущего!
//       </p>
//     </div>
//   );
// }
